...
// Pass this if window is not defined yet
  ...
  var $ = {};
  var style = "#__previewImage-container{-ms-touch-action:none;touch-action:none;-webkit-touch-action:none;line-height:100vh;background-color:#000;width:100vw;height:100vh;position:fixed;overflow:hidden;top:0;left:0;z-index: 2147483647;transition:transform .3s;-ms-transition:transform .3s;-moz-transition:transform .3s;-webkit-transition:transform .3s;-o-transition:transform .3s;transform:translate3d(100%,0,0);-webkit-transform:translate3d(100%,0,0);-ms-transform:translate3d(100%,0,0);-o-transform:translate3d(100%,0,0);-moz-transform:translate3d(100%,0,0)}#__previewImage-container .previewImage-close{z-index:2147483649;position: absolute;top: 1em;right: .8em;display: inline-block;height: 30px;width: 30px;line-height: 30px;background: url(libs/images/qz-bg-a.png) 0 -30px no-repeat;color:#fff;border-radius: 50%;text-align: center;}#__previewImage-container .previewImage-text{position:absolute;top:.6em;text-align:center;font-size:18px;line-height:25px;color:#fff;z-index:10;padding: 0.2em 0.4em;background-color: rgba(255,255,255,0.4);border-radius: 50%;letter-spacing: 0;left:.8em}#__previewImage-container .previewImage-text .previewImage-text-index{font-size: 24px;}#__previewImage-container .previewImage-box{width:999999rem;height:100vh}#__previewImage-container .previewImage-box .previewImage-item{display: flex;flex-direction: column;justify-content: center;width:100vw;height:100vh;margin-right:15px;float:left;text-align:center;background:url(http://static.luyanghui.com/svg/oval.svg) no-repeat center/auto}#__previewImage-container .previewImage-box .previewImage-item.previewImage-nobackground{background:none}#__previewImage-container .previewImage-box .previewImage-item .previewImage-image{vertical-align:middle;max-width:100%;max-height:100%;margin:0 auto;}";
  ...
  _previewImage.prototype.render = function(){
      ...
      this.$close = document.createElement('div'); // 关闭预览按钮
      this.$close.className += 'previewImage-close';
  ...
  _previewImage.prototype.bind = function(){
      ...
      $container.addEventListener('click', function (e) {
        if (e.target.className.indexOf('previewImage-item') > -1 || e.target.className.indexOf('previewImage-close') > -1) {
          closePreview()
        }
      })
  ...
  _previewImage.prototype.addCssPrefix = function(elem,prop,value){    //可以优化todo
      for(var i in this.cssprefix){
          ...
          if(cssprefix===""){
              ...
              var len = prop.length;
              prop = cssprefix + prop.substr(0,1).toUpperCase()+prop.substr(1,len).toLowerCase()
          }
